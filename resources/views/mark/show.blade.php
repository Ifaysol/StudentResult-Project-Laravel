                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <table class="w-full">
                            ...
                            <tbody class="bg-white">
                                ...
                                @forelse ($total_mark as $key => $show)
                                    <tr class="text-gray-700">
                                        <td class="px-4 py-3 border">{{$key+1}}</td>
                                        <td class="px-4 py-3 text-ms font-semibold border">{{ $show->student_id }}</td>
                                       
                                        <td class="px-4 py-3 text-ms font-semibold border">{{ $show->sum }}</td>
